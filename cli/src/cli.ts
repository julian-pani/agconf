...
export function createCli(): Command {
  ...
  program
    ...
    .option("--hook", "Emit the SessionStart hook envelope (JSON) instead of human-readable text")
    .action(async (options: { installHook?: boolean; quiet?: boolean; hook?: boolean }) => {
